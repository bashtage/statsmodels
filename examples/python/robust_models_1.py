...
# get_ipython().run_line_magic('R', 'library(robustbase)')
# get_ipython().run_line_magic('Rpush', 'yy xx')
# get_ipython().run_line_magic('R', 'mod <- lmrob(yy ~ xx);')
# get_ipython().run_line_magic('R', 'params <- mod$coefficients;')
# get_ipython().run_line_magic('Rpull', 'params')

# In[ ]:

# get_ipython().run_line_magic('R', 'print(mod)')
